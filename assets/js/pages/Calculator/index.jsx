...
import thousandSeparator from "~Scripts/utils/thousandSeparator";
    ...
    return (
      <div className="calc-container">
        <div className="calc-tab">
          <ul id="top-menu">
            {this.menu.map(obj => {
              const cn = classNames("tab-item", {
                active: obj.id === activeMenuId
              });
              return (
        ...
        <div className="calc-content">
          <div className="content-left">
            <div className="main-panel">
              ...
              <p className="main-amount">
                {"$"}
                {thousandSeparator(loanAmountValue, ",")}
              </p>
          ...
          <div className="content-right">
              ...
              <div className="row-sub-group">
                ...
                <div className="content-row">
                  ...
                  <div>
                    <p>
                      {"$"}
                      {this.formatValue(calc.totalPaid)}
                    </p>
                  </div>
                </div>
                <div className="subtitle-row">
                ...
                <div className="content-row margin-top">
                  ...
                  <div>
                    <p>
                      {calc.timeSavedMonthes} {calc.monthString}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="big-row">
              <div>
                <h3>{`$ ${this.formatValue(calc.amountSaved)} SAVED`}</h3>
              </div>
            </div>
          </div>
        </div>
