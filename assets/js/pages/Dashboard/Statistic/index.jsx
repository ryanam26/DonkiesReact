...
import DashboardColorBlock from "./Block";
  ...
  render() {
    ...
    return (
      <div className="row">
        ...
        <DashboardColorBlock
          value={`$${
            stat.roundup_since_signup ? stat.roundup_since_signup.toFixed(2) : 0
          }`}
        ...
        <DashboardColorBlock
          value={`$${
            stat.monthly_average_roundup
              ? stat.monthly_average_roundup.toFixed(2)
              : 0
          }`}
        ...
        <DashboardColorBlock
          value={`$${
            stat.yearly_average_roundup
              ? stat.yearly_average_roundup.toFixed(2)
              : 0
          }`}
