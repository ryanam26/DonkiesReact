...
$(document).ready(function() {
  ...
  if ($("#weather-widget")[0]) {
    $.simpleWeather({
      ...
      success: function(weather) {
        ...
        html +=
          '<span class="weather-list-icon wi-' +
          weather.forecast[2].code +
          '"></span><span>' +
  ...
  if ($("#input-slider-value")[0]) {
    ...
    sliderRangeValue.noUiSlider.on("update", function(values, handle) {
      document.getElementById("input-slider-value-output").innerHTML =
        values[handle];
    });
  }
  ...
  if ($(".color-picker")[0]) {
    $(".color-picker").each(function() {
      var colorOutput = $(this)
        .closest(".cp-container")
        .find(".cp-value");
