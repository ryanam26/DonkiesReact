...
export const registrationStep1 = (form) => action(REGISTRATION_STEP1.SUBMIT, {form})
export const registrationStep2 = (form) => action(REGISTRATION_STEP2.SUBMIT, {form})
export const registrationStep3 = (form) => action(REGISTRATION_STEP3.SUBMIT, {form})
export const registrationStep4 = (form) => action(REGISTRATION_STEP4.SUBMIT, {form})
