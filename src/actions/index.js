...
export const CLOSE_DONKIES_ACCOUNT = createRequestTypes(
  "CLOSE_DONKIES_ACCOUNT"
);
...
export const REGISTRATION_STEP1 = createRequestTypes("REGISTRATION_STEP1");
export const REGISTRATION_STEP2 = createRequestTypes("REGISTRATION_STEP2");
export const REGISTRATION_STEP3 = createRequestTypes("REGISTRATION_STEP3");
export const REGISTRATION_STEP4 = createRequestTypes("REGISTRATION_STEP4");
export const REGISTRATION_PARENT = createRequestTypes("REGISTRATION_PARENT");
export const RESET_PASSWORD_REQUEST = createRequestTypes(
...
export const apiGetRequest = (name, params, url = null) =>
  action(API_GET_REQUEST.FETCH, { name, params, url });
...
export const apiEditRequest = (name, id, form, url = null) =>
  action(API_EDIT_REQUEST.SUBMIT, { name, id, form, url });

// layout
export const alertAdd = (alertType, message) =>
  action(ALERT_ADD, { alertType, message });
export const alertRemove = message => action(ALERT_REMOVE, { message });
export const growlAddRequest = payload =>
  action(GROWL_ADD_REQUEST, { payload });
export const navigate = pathname => action(NAVIGATE, { pathname });
export const resetErrorMessage = () => action(RESET_ERROR_MESSAGE);
export const setFormErrors = (formType, errors) =>
  action(FORM_ERRORS, { formType, errors });
...
// finance
export const accountsSetActive = (id, form) =>
  action(ACCOUNTS_SET_ACTIVE.SUBMIT, { id, form });
export const accountsSetNumber = (id, form) =>
  action(ACCOUNTS_SET_NUMBER.SUBMIT, { id, form });
export const accountsSetPrimary = id =>
  action(ACCOUNTS_SET_PRIMARY.SUBMIT, { id });
export const createItem = (publicToken, account_id) =>
  action(CREATE_ITEM.SUBMIT, { publicToken, account_id });
...
export const login = (email, password) =>
  action(LOGIN.SUBMIT, { email, password });
...
export const registrationStep1 = form =>
  action(REGISTRATION_STEP1.SUBMIT, { form });
export const registrationStep2 = form =>
  action(REGISTRATION_STEP2.SUBMIT, { form });
export const registrationStep3 = form =>
  action(REGISTRATION_STEP3.SUBMIT, { form });
export const registrationStep4 = form =>
  action(REGISTRATION_STEP4.SUBMIT, { form });
export const registrationParent = form =>
  action(REGISTRATION_PARENT.SUBMIT, { form });
...
export const editUserSettings = form =>
  action(EDIT_USER_SETTINGS.SUBMIT, { form });
export const resetPasswordRequest = form =>
  action(RESET_PASSWORD_REQUEST.SUBMIT, { form });
