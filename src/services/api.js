...
export const CREDENTIALS_LIVE_BY_CODE_URL = `${API_ROOT_URL}v1/credentials/live/code`
export const CREDENTIALS_LIVE_BY_ID_URL = `${API_ROOT_URL}v1/credentials/live/id`
